...
const PORTUGAL2BRASIL2PT = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('BRASIL + PORTUGAL PT'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/pt2br2.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
...
export default PORTUGAL2BRASIL2PT;
