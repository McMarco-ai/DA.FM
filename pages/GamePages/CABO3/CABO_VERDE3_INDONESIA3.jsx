...
const CABOVERDE3INDONESIA3EN = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('INDONÉSIA + CABO VERDE EN'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/cv3in3.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
...
export default CABOVERDE3INDONESIA3EN;
