...
const CABOVERDE3CABOVERDE1PT = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('CABO VERDE + CABO VERDE PT'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/cv1cv3.mp4')} 
                    style={styles.video}
                    resizeMode="cover"
...
export default CABOVERDE3CABOVERDE1PT;
