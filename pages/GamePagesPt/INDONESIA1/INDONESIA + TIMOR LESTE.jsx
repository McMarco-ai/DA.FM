    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.title}>
                ...
                <Image
                    source={require('../../assets/tlin.png')} // Replace with your image URL
                    style={styles.image}
                />
            ...
            <View style={styles.buttonsContainer}>
                ...
                <Text style={styles.buttonText}>COMPARA OUTRO PAR</Text>
                </Pressable>
...
export default INDONESIATIMORLESTEPT;
