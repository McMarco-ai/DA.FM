...
const BASE_WIDTH = 375; // Use a base width for scaling
const BASE_HEIGHT = 812; // Use a base height for scaling
...
const GamePt = () => {
  ...
  const [buttonsReady, setButtonsReady] = useState(false); // Control button rendering
  ...
  const buttons = [
    { label: 'INDONÉSIA 1PT', color: '#ACB7DD', top: 20, left: 10, rotation: '355deg' },
    { label: 'TIMOR LESTE 1PT', color: '#E1B8D6', top: 20, left: 150, rotation: '10deg' },
    { label: 'PORTUGAL 1PT', color: '#F39F21', top: 95, left: 15, rotation: '330deg' },
    { label: 'CABO VERDE 1PT', color: '#F16264', top: 80, left: 145, rotation: '10deg' },
    { label: 'INDONÉSIA 2PT', color: '#ACB7DD', top: 140, left: 80, rotation: '350deg' },
    { label: 'BRASIL 1PT', color: '#89DEBA', top: 160, left: 210, rotation: '15deg' },
    { label: 'PORTUGAL 2PT', color: '#F39F21', top: 60, left: 270, rotation: '100deg' },
    { label: 'BRASIL 2PT', color: '#89DEBA', top: 210, left: 0, rotation: '345deg' },
    { label: 'TIMOR LESTE 2PT', color: '#E1B8D6', top: 290, left: 135, rotation: '60deg' },
    { label: 'CABO VERDE 2PT', color: '#F16264', top: 270, left: 20, rotation: '335deg' },
    { label: 'INDONÉSIA 3PT', color: '#ACB7DD', top: 335, left: 90, rotation: '70deg' },
    { label: 'PORTUGAL 3PT', color: '#F39F21', top: 203, left: 150, rotation: '15deg' },
    { label: 'CABO VERDE 3PT', color: '#F16264', top: 260, left: 230, rotation: '305deg' },
    { label: 'BRASIL 3PT', color: '#89DEBA', top: 360, left: 200, rotation: '340deg' },
    { label: 'TIMOR LESTE 3PT', color: '#E1B8D6', top: 335, left: -10, rotation: '180deg' },
  ];
  ...
  const adjustedButtons = buttons.map((button) => ({
    ...
    left: clampValue(
      ...
      0,
      SCREEN_WIDTH - 150
    ), // Adjust width for button size
    top: clampValue(
      scaleValue(button.top, BASE_HEIGHT, SCREEN_HEIGHT),
      0,
      SCREEN_HEIGHT - 60
    ), // Adjust height for button size
  }));

  useEffect(() => {
    // Simulate a delay to ensure layout calculations are correct
...
const styles = StyleSheet.create({
  ...
  buttonsContainer: {
    position: 'relative',
    width: '100%',
    height: scaleValue(500, BASE_HEIGHT, SCREEN_HEIGHT), // Adjust height as needed
    justifyContent: 'center',
    alignItems: 'center',
    overflow: 'hidden',
  },
