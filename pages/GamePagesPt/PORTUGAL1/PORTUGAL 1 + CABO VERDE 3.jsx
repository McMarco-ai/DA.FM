...
const PORTUGAL1CABOVERDE3PT = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('PORTUGAL + CABO VERDE PT'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/cv3pt1.mp4')} 
                    style={styles.video}
                    resizeMode="cover"
...
export default PORTUGAL1CABOVERDE3PT;
