...
const TIMORLESTE2PORTUGAL3PT = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('PORTUGAL + TIMOR LESTE PT'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/pt3tl2.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
            ...
            <View style={styles.buttonsContainer}>
                ...
                <Pressable onPress={handlePressForward} style={[styles.button, styles.buttonRight]}>
                    <Text style={styles.buttonText}>NÂO</Text>
                </Pressable>
            </View>
        </ScrollView>
...
export default TIMORLESTE2PORTUGAL3PT;
