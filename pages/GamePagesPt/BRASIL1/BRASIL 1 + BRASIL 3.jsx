...
const BRASIL1BRASIL3PT = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('BRASIL + BRASIL PT'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.title}>
                ...
                OUVE COM ATENÇÃO                </Text>
            </View>

            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/br1br3.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
            ...
            <View style={styles.titleDown}>
                <Text style={styles.titleText}>
                    ESTES INDIVÍDUOS SÃO DIFERENTES?                </Text>
            </View>
...
export default BRASIL1BRASIL3PT;
