...
const INDONESIA3INDONESIA2PT = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('INDONÉSIA + PORTUGAL PT'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/in2in3.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
...
export default INDONESIA3INDONESIA2PT;
