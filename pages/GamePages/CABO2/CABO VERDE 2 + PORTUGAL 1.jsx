...
const CABOVERDE2PORTUGAL1EN = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('PORTUGAL + CABO VERDE EN'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/cv2pt1.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
...
export default CABOVERDE2PORTUGAL1EN;
