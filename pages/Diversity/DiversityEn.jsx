        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.firstPara}>
                ...
                <Text style={styles.parasmallText}>
                    Explore remarkable genetic similarities among humans!
                </Text>
            </View>
            ...
            <ScrollView horizontal contentContainerStyle={styles.horizontalScrollContainer}>
                <Image
                    ...
                    source={require('../assets/diversity1En.png')}
                />
                <Image
                    style={styles.horizontalImage}
                    source={require('../assets/diversity2En.png')}
                />
                <Image
                    style={styles.horizontalImage}
                    source={require('../assets/diversity3En.png')}
                />
                <Image
                    style={styles.horizontalImage}
                    source={require('../assets/diversity4En.png')}
                />
                <Image
                    style={styles.horizontalImage}
                    source={require('../assets/diversity5En.png')}
                />
                <Image
                    style={styles.horizontalImage}
                    source={require('../assets/diversity6En.png')}
                />
                <Image
                    style={styles.horizontalImage}
                    source={require('../assets/diversity7En.png')}
                />
            </ScrollView>

            <View style={styles.textContainerBackground}>
                <Text style={styles.normalTextGray}>
                    Explore this diversity through sound! Experience this diversity audibly in the interactive topic DA.FM.
                </Text>
            </View>
