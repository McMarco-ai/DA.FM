...
const TIMORLESTE1TIMORLESTE3EN = () => {
    const navigation = useNavigation();
    const [videoEnded, setVideoEnded] = useState(false);
    const videoRef = useRef(null);

    const handlePressForward = () => {
        navigation.navigate('TIMOR LESTE + TIMOR LESTE EN'); // Update with your target route
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            {!videoEnded ? (
                <Video
                    ref={videoRef}
                    source={require('../../assets/tl1tl3.mp4')} // Replace with your video URL
                    style={styles.video}
                    resizeMode="cover"
...
export default TIMORLESTE1TIMORLESTE3EN;
